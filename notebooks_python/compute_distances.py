...
#df_duos_approx.to_csv('df_duos_approx.csv')
#df_duos_gurobi.to_csv('df_duos_gurobi.csv')

#df_duos_times_approx.to_csv('df_times_approx.csv')
#df_duos_times_gurobi.to_csv('df_times_gurobi.csv')
